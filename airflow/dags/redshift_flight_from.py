...
def merge_csv_from_s3():
    ...
    file_keys = [
        'source/source_flight/flight_from_japan.csv',
        'source/source_flight/flight_from_china.csv',
        'source/source_flight/flight_from_asia.csv',
        'source/source_flight/flight_from_europe.csv',
        'source/source_flight/flight_from_usa.csv',
        'source/source_flight/flight_from_other.csv'
    ]
...
def upload_to_redshift(data):
    ...
    cur.execute("drop table if exists flight.flight_from")
    conn.commit()
    ...
    for i, r in data.iterrows():
        insert_query = "INSERT INTO flight.flight_from VALUES (%s, %s, %s, %s, %s, %s, %s, %s);"
