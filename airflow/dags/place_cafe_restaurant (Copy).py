...
def fetch_places_data(**context):
    try:
        ...
        raise 
    chunks = np.array_split(locations, 12)
...
dag = DAG(
    'place_cafe_restaurant_distributed',
...
read_events_from_s3_task >> processing_group >> preprocess_redshift_task >> load_to_redshift_task
